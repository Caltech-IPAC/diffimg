...
def generateScienceImageCatalog(filename_sciimage_image,
    ...
    sextractor_sciimage_dict["sextractor_PARAMETERS_NAME".lower()] = cfg_path + "/srcExtractParamsSciImage.inp"
    sextractor_sciimage_dict["sextractor_FILTER_NAME".lower()] = cfg_path + "/srcExtractSciImageFilter.conv"
    sextractor_sciimage_dict["sextractor_STARNNW_NAME".lower()] = cfg_path + "/srcExtractSciImageStarGalaxyClassifier.nnw"
